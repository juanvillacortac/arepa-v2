...
{:else}
  <select
    class="bg-white border rounded border-gray-300 text-xs leading-tight w-full py-2 px-3 appearance-none !pr-8 dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline"
