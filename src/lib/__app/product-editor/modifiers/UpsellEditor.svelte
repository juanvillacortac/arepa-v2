...
>
      ...
      {#if open[i.internalId]}
        ...
        >
          ...
          <div class="relative">
            ...
            {/if}
            <div
              class="border-dashed rounded-lg flex border-2 p-2 overflow-hidden relative pointer-events-none darkborder-dark-700 dark:border-dark-700"
            >
              {#if i.meta?.image}
                <Image
                  {options}
  ...
  {:else}
    <div
      class="bg-gray-50 text-xs w-full text-gray-500 dark:bg-dark-400 dark:text-gray-400"
