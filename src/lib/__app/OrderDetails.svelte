...
{#if restoreEmailDialog}
  ...
  >
    ...
    />
    <div
      class="bg-white rounded-xl flex flex-col space-y-4 shadow max-h-9/10 max-w-9/10 p-4 relative lg:max-w-4/10 dark:bg-dark-900"
      style="will-change: transform"
      transition:scale={{ start: 0.9, duration: 400, easing: expoOut }}
    >
      <div class="flex items-center justify-between">
...
<div class="w-full grid gap-4 grid-cols-1 lg:grid-cols-10">
  <div class="flex flex-col space-y-4 lg:col-span-7 <lg:row-start-2">
    {#if order.items.length}
      <div
        class="bg-white border rounded-lg flex flex-col border-gray-300 w-full relative overflow-hidden dark:divide-dark-700 dark:bg-dark-800 dark:border-dark-400"
      >
        <div
          class="border-b flex space-x-2 border-gray-300 w-full p-4 justify-between items-center dark:border-dark-400"
        >
        ...
        <div
          class="divide-y flex flex-col border-gray-300 w-full max-h-65vh relative overflow-x-auto overscroll-auto lg:max-h-176px dark:divide-dark-700 dark:bg-dark-800 dark:border-dark-400"
        >
                ...
                {#if fulfillmentMode}
                  <div class="flex flex-col space-y-1">
                    ...
                    <div class="flex !text-xs">
                      ...
                      <input
                        class="bg-white border-t border-b border-gray-300 border-l-0 border-r-0 text-xs text-center leading-tight py-1 px-2 w-8ch quantity fulfillment dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline focus:z-10"
                        type="number"
  ...
  <div class="flex flex-col h-full space-y-4 w-full relative lg:col-span-3">
          ...
          <div class="flex space-x-2 w-full items-center">
            ...
            <p class="text-xs">
              This order was placed from IP address <span
                class="rounded cursor-pointer font-bold font-mono bg-gray-100 p-1 dark:bg-dark-700"
                title="Copy address"
                on:click={() => {
    ...
    {#if mode === 'app'}
      ...
      >
        ...
        <div
          class="border rounded-full flex font-bold font-title mx-auto from-green-300 to-pink-600 border-gray-500 h-72px text-4xl leading-[0] w-72px items-center justify-center uppercase dark:bg-dark-600 dark:from-green-400 dark:to-pink-700"
