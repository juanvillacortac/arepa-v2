...
<div
  class="divide-y border rounded-lg flex flex-col w-full relative overflow-x-auto dark:divide-dark-400 dark:border-dark-400"
>
  <table class="text-sm text-left w-full text-gray-500 dark:text-gray-400">
    <thead
      class="bg-gray-50 text-xs text-gray-700 uppercase !z-30 dark:bg-dark-700 dark:text-gray-400"
    ...
    <tbody class="z-10 relative">
        ...
        >
          ...
          >
            <div class="flex space-x-2 items-center">
              <div class="h-32px w-32px relative">
                ...
                />
                <button
                  class="rounded h-full border-2 h-32px w-full transform w-32px relative dark:border-dark-400"
                  title={i.meta.name}
                  type="button"
                  {disabled}
                  on:click={() =>
              ...
              <input
                ...
                class="border rounded cursor-pointer bg-gray-50 border-gray-300 text-xs leading-tight w-full py-2 px-3 appearance-none dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline"
                bind:value={i.name}
                required
              />
            </div>
          ...
          <td class="py-4 px-6">
            <input
              ...
              class="bg-white border rounded border-gray-300 text-xs leading-tight w-full py-2 px-3 appearance-none <sm:w-24ch dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline"
      ...
      {:else}
        <tr
          class="bg-gray-50 text-xs text-gray-500 dark:bg-dark-400 dark:text-gray-400"
        >
