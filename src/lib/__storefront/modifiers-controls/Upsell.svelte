      ...
      >
        {#if selected && !disabled}
          <button
            ...
            class="bg-white border rounded-full border-gray-300 shadow p-1 transform top-0 right-0 z-20 translate-x-[25%] translate-y-[-25%] absolute dark:bg-dark-700 dark:border-dark-400"
          >
            <Close24 />
          </button>
        {/if}
        ...
        <div class="flex flex-col h-full space-y-2 p-2 justify-between">
          <div class="flex flex-col space-y-2">
            <div
              class="rounded-lg bg-gray-100 w-auto overflow-hidden pointer-events-none select-none dark:bg-dark-700"
            >
              <div
