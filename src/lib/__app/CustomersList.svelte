...
<div
  class="border rounded-lg flex flex-col space-y-4 bg-gray-50 border-gray-300 p-4 dark:bg-dark-800 dark:border-dark-400"
>
  <div class="flex space-x-2 w-full justify-between items-center">
    ...
    <Submenu>
      ...
      >
      <div
        class="flex flex-col font-bold divide-y-1 divide-gray-300 text-xs text-gray-80 dark:divide-dark-600 dark:text-white"
        slot="body"
      >
  ...
  {:else}
    ...
    >
      ...
      {:else if $media.small}
        <div
          class="flex flex-col divide-y-1 divide-gray-300 w-full dark:divide-dark-600"
        >
          {#each customers as c, idx}
            <button
              class="flex flex-col space-y-2 w-full p-2 text-gray-700 dark:text-gray-400"
              on:click={() => goto(`/customers/${c.id}`)}
            >
              ...
              <div class="flex space-x-2 w-full items-center">
                <div
                  class="bg-gradient-to-br border rounded-full cursor-pointer flex font-bold font-title from-green-300 to-pink-600 border-gray-200 h-32px text-white text-xs min-w-32px leading-[0] items-center justify-center uppercase dark:bg-dark-600 dark:from-green-400 dark:to-pink-700"
                >
                  {c.firstName[0]}
                </div>
          ...
          <tbody>
            {#each customers as c, idx}
              <tr
                ...
                class:dark:border-dark-700={idx !== customers.length - 1}
              >
                <th
                  scope="row"
                ...
                <td>
                  <div class="flex">
                    <div
                      class="bg-gradient-to-br border rounded-full cursor-pointer flex font-bold font-title mx-auto from-green-300 to-pink-600 border-gray-200 h-32px text-white text-xs min-w-32px leading-[0] w-32px items-center justify-center uppercase dark:bg-dark-600 dark:from-green-400 dark:to-pink-700"
                    >
                      {c.firstName[0]}
                    </div>
                  </div>
