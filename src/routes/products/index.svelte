...
<div class="flex mx-auto justify-center items-center lg:w-9/10">
  <div class="flex mb-8 <sm:hidden !text-xs">
    <input
      class="bg-white border rounded-l-full border-gray-300 text-xs leading-tight w-full py-2 px-3 appearance-none lg:w-20rem dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline focus:z-10"
      type="text"
      bind:value={textSearch}
      placeholder="Enter keywords to search..."
    />
    <select
      class="bg-white border-b border-l-0 border-gray-300 leading-tight py-2  px-3 w-10rem appearance-none <sm:hidden !border-t dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline"
    ...
    <select
      class="bg-white border-b rounded-r-full border-l-0 border-gray-300 leading-tight py-2  px-3 w-10rem appearance-none <sm:hidden !border-t dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline"
...
{#if filteredProducts?.length}
  <div
    class="divide-y border rounded-lg flex flex-col border-gray-300 w-full relative overscroll-auto dark:divide-dark-700 dark:bg-dark-800 dark:border-dark-700 "
