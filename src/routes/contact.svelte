    ...
    >
      ...
      <div class="flex flex-col w-full">
        ...
        <textarea
          ...
          required
          class="bg-white border rounded border-gray-300 h-24 text-xs leading-tight w-full py-2 px-3 appearance-none dark:bg-dark-700 dark:border-dark-400 focus:outline-none focus:shadow-outline"
          bind:value={message}
        />
      </div>
